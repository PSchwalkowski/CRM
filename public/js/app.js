...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('auth-login', __webpack_require__(42));
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
	...
	methods: {
		initFoundation: function initFoundation() {
			var dropdownMenu = $('[data-dropdown-menu]');
			var drilldown = $('[data-drilldown]');

			if (dropdownMenu.length) new Foundation.DropdownMenu(dropdownMenu);
			if (drilldown.length) new Foundation.Drilldown(drilldown);
		},
		...
		initPlaceholderData: function initPlaceholderData() {
			...
			if (avatar) {
				...
				axios.get('https://randomuser.me/api/').then(function (response) {
					...
					var newAvatar = response.data.results[0].picture.thumbnail;
...
try {
	window.jQuery = __webpack_require__(29);
...
/* harmony default export */ __webpack_exports__["default"] = ({
	methods: {
		...
		formSubmit: function formSubmit(event) {
			event.preventDefault();
			var callout = $('.callout', event.target);
...
Component.options.__file = "D:\\xampp\\htdocs\\CRM\\resources\\assets\\js\\components\\Auth\\Login.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-99fe35f0", Component.options)
  } else {
    hotAPI.reload("data-v-99fe35f0", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "column small-centered small-4"
  }, [_c('form', {
    on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-99fe35f0", module.exports)
  }
}
